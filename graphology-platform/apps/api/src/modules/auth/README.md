...
Login, JWT, cookies, OAuth, password reset, email verification, and RBAC enforcement.
...
| **Services** | Application use-cases. Depend on repository interfaces, never Prisma. Hash passwords before persistence. |
...
| **DTOs** | Request validation (`RegisterDto`, placeholders for login/reset/etc.). |
