    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "schema", "label": "Schema", "type": "text", "required": False, "default": "PUBLIC",
             "placeholder": "PUBLIC or *",
             "help": "Use * to scan all schemas in the database."},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "dataset", "label": "Default dataset", "type": "text", "required": False, "prefill_from": "dataset",
             "placeholder": "analytics or *",
             "help": "Use * to scan all datasets in the project."},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "catalog", "label": "Catalog", "type": "text", "required": False,
             "placeholder": "agentops",
             "help": "Unity Catalog name. Required for production tables outside hive_metastore."},
            {"name": "schema", "label": "Schema", "type": "text", "required": False, "default": "default",
             "placeholder": "agent_logs or *",
             "help": "Schema to scan. Use * to scan all schemas in the catalog (recommended)."},
        ],
    },
    {
        "kind": "MONGODB",
